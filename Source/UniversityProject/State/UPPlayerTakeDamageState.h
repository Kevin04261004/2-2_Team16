...
#include "UPPlayerTakeDamageState.generated.h"

/**
 * 
 */
UCLASS()
class UNIVERSITYPROJECT_API UUPPlayerTakeDamageState : public UUPPlayerBaseSkillState
{
	GENERATED_BODY()
		
public:
	UUPPlayerTakeDamageState();
