...
#include "Animation/Notify/UPLerpToTargetPosAnimNotifyState.h"

void UUPLerpToTargetPosAnimNotifyState::NotifyBegin(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation,
	float InTotalDuration)
{
	...
	if (AActor* Owner = MeshComp->GetOwner())
	{
		...
		TargetLocation = StartLocation + TargetLocalLocation;
		StartTime = MeshComp->GetWorld()->GetTimeSeconds();
		TotalDuration = InTotalDuration;
	}
}

void UUPLerpToTargetPosAnimNotifyState::NotifyTick(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation,
...
void UUPLerpToTargetPosAnimNotifyState::NotifyEnd(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
